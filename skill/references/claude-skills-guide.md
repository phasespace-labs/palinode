...
seconds — including pages, databases, and templates — instead of spending
...
For full, production-ready examples demonstrating the patterns in this guide:
...
## Output-Extraction Method (Practical Addition)

**From:** Nate B Jones Substack, March 2026

Don't write skills from intentions — write them from outputs.

1. Collect 10-20 examples of your actual best work in that domain
2. Feed them to Claude
3. Ask Claude to identify decisions embedded in the examples and reverse-engineer a SKILL.md
4. Have Claude interview you about why those examples were good
5. Test with vague, realistic prompts — not engineered test cases

Why it works: expertise lives in automatic decisions you can't consciously articulate. Output-extraction surfaces the methodology from evidence rather than from your description of it.

> "What you think you do and what you actually do are different."

**For Palinode skills specifically:** collect sessions where memory search/save worked well, feed those to Claude, let it identify what made them effective.
