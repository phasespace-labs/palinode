...
def test_missing_fields_are_skipped(temp_memory_file):
    ...
    # as unmatched.
    assert stats == {"kept": 0, "updated": 0, "merged": 0, "superseded": 0, "archived": 0, "retracted": 0, "merge_rejected": 0, "protected_rejected": 0, "contradicts_proposed": 0, "unmatched": 4, "review_flagged": 0}
...
def test_empty_operations_leave_file_unchanged(temp_memory_file):
    ...
    with open(temp_memory_file, encoding="utf-8") as f:
        after = f.read()
    assert before == after
    assert stats == {"kept": 0, "updated": 0, "merged": 0, "superseded": 0, "archived": 0, "retracted": 0, "merge_rejected": 0, "protected_rejected": 0, "contradicts_proposed": 0, "unmatched": 0, "review_flagged": 0}
